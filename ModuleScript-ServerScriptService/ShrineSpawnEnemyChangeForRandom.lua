local module = {}
function module.RandomEnemy(parent, enemiesfolder)
	local shrine = parent
...
function module.SpecificEnemy(parent, enemy)
	local shrine = parent
	local enemyTemplate = enemy
	...
	local function spawnEnemy()
		if not enemyTemplate then
			warn("Enemy template not found in ServerStorage!")
			return
		end
